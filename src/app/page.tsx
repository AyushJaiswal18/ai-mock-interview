        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="text-lg px-8 py-6 h-auto bg-white text-black hover:bg-gray-100 font-medium" asChild>
                <Link href={NAV_CONFIG.signUp.path}>
                  Start today for free
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Link>
              </Button>
              <Button variant="outline" size="lg" className="text-lg px-8 py-6 h-auto border-white/20 text-white hover:bg-white/10 font-medium" asChild>
                <Link href="#demo">
                  Book a demo
                </Link>
              </Button>
            ...
            <div className="bg-gray-900/50 border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm">
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex space-x-1">
                    <div className="px-3 py-1 bg-gray-800 text-gray-300 text-sm rounded">Dashboard</div>
                    <div className="px-3 py-1 bg-blue-600 text-white text-sm rounded">Interview</div>
                    <div className="px-3 py-1 bg-gray-800 text-gray-300 text-sm rounded">Practice</div>
                    <div className="px-3 py-1 bg-gray-800 text-gray-300 text-sm rounded">Analytics</div>
                  </div>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white text-sm font-bold">AS</div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-y border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
              <div className="w-16 h-16 bg-pink-500/20 rounded-2xl flex items-center justify-center mx-auto mb-6 border border-pink-500/30">
